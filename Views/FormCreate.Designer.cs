...
namespace IT_ilisateurs
{
    partial class FormCreate
    {
        ...
        private void InitializeComponent()
        {
            ...
            Button ActionCreateUserButton = new Button();
            this.Controls.Add(ActionCreateUserButton);
            ActionCreateUserButton.Text = "Créer l'utilisateur";
            ActionCreateUserButton.AutoSize = true;
            ActionCreateUserButton.Location = new Point(375,600);
            ActionCreateUserButton.MouseClick += ActionCreateUserButton_Click;

            void ActionCreateUserButton_Click(object sender, EventArgs e)
            {
                CreateUser(NameTextBox.Text, FirstNameTextBox.Text, EmailTextBox.Text, PasswordTextBox.Text, BirthdateTextBox.Text, AddressTextBox.Text, UserFlagComboBox.Text);
            }
        }
